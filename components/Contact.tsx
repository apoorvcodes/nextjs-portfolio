...
const Contact:FC = () => {
	...
	const sendEmail = (e: any) => {
		e.preventDefault()
		emailjs.sendForm('service_totu', 'template_ebl644l', form.current, 'user_3POmBlypOgWDh2J98kuoc')
		  .then((result) => {
		  ...
		  <div className="flex flex-row-reverse justify-center my-6 pt-6">
			...
			<div className="px-8 mb-4 text-center">
			  ...
			  <p className="mb-4 text-sm text-gray-300">
			    We get it, you want some talks. Just enter your email
			    address and message below and I'l talk to you!
			  </p>
			</div>
			<form  onSubmit={sendEmail} ref={form} className="px-8 pt-6 pb-8 mb-4 rounded" id="contactform" >
			  <div className="mb-4">
			    <label
			      className="block mb-2 text-sm font-bol text-gray-300"
