    ...
    <div className="mx-auto container ">
      <div className="grid  grid-rows-reversed-1 md:grid-cols-2 ">
        <div className="flex flex-col justify-center pl-6 pb-4 md:pb-0">
          <div className="text-3xl font-brd text-gry pl-2">
            {tags.start.hero}
          </div>
          <div className="text-4xl md:text-7xl  font-bold text-cream font-sans">
            Hi,
          </div>
          ...
          <div className="text-3xl  font-bold text-gry font-sans">
      ...
      <div
        ...
        className="flex justify-center text-4xl text-prime pt-6 "
      >
        <BsMouse />
      </div>
    </div>
